...
import TechCommImporter from './TechCommImporter';
...
async function main() {
  const handler = new FSHandler('output/techcomm', console);
  ...
  const importer = new TechCommImporter({
    storageHandler: handler,
    blobHandler: blob,
    cache: '.cache/techcomm'
  });
