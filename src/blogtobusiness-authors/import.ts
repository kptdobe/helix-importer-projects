...
import BlogToBlogAuthorImporter from './BlogToBusinessAuthorImporter';
...
async function getAuthors() {
  const req = await fetch('https://main--business-website--adobe.hlx3.page/drafts/fkakatie/importer-authors.json');
  if (req.ok) {
